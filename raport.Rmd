...
kable(data3, align = "l") %>%
  ...
  kableExtra::scroll_box(width = "100%", height = "400px")
```
Jak wynika z tabeli, najwięcej (`r wycieczki_max_procent$Procent`%) klientów powraca 
do miast: `r wycieczki_max_procent$Wycieczka`. 

Najmniej osób (`r wycieczki_min_procent$Procent`%)
ponownie wybiera się do `r wycieczki_min_procent$Wycieczka`.
